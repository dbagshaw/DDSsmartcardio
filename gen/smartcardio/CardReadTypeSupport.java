 ...
 * CardRead.
 */
public class CardReadTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "smartcardio::CardRead";
    ...
    private static final CardReadTypeSupport _singleton
        = new CardReadTypeSupport();
     ...
     */
    public static CardReadTypeSupport get_instance() {
        return _singleton;
    }

    public static CardReadTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return CardRead.create();
    }
     ...
     * <code>this</code> is not a <code>CardRead</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        CardRead typedDst = (CardRead) destination;
        CardRead typedSrc = (CardRead) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        CardRead typedSrc = (CardRead) sample;
        ...
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.unique_identifier);
...
CardRead typedSrc = (CardRead) src;    
        ...
        dst.writeString(typedSrc.unique_identifier,(64));
...
CardRead typedDst = (CardRead) dst;
        
            typedDst.clear();
    try {

            typedDst.unique_identifier = src.readString((64));
...
CardRead typedDst = (CardRead) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
CardRead typedDst = (CardRead) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new CardReadDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new CardReadDataReader(native_reader, listener, mask, this);                
    ...
    protected CardReadTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CardReadTypeCode.VALUE,CardRead.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected CardReadTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,CardReadTypeCode.VALUE,CardRead.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
