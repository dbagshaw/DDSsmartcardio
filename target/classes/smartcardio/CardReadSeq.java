...
public final class CardReadSeq extends LoanableSequence implements Copyable {
    ...
    public CardReadSeq() {
        super(CardRead.class);
    }


    public CardReadSeq(int initialMaximum) {
        super(CardRead.class, initialMaximum);
    }
    ...
    public Object copy_from(Object src) {
        ...
        for(int i = 0; (i < origSize) && (i < srcSize); i++){
            if (typedSrc.get(i) == null){
                ...
                if (get(i) == null){ 
                    set(i, CardRead.create());
                }
                set(i, ((Copyable) get(i)).copy_from(typedSrc.get(i)));
            }
        }
        
        // copy 'new' CardRead objects (beyond the original size of this object)
